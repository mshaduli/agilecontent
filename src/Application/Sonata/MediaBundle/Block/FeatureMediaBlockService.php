...
use Sonata\MediaBundle\Block\FeatureMediaBlockService as BaseFeatureMediaService;
 ...
 */
class FeatureMediaBlockService extends BaseFeatureMediaService
{
    /**
     * {@inheritdoc}
     */
    ...
    public function execute(BlockInterface $block, Response $response = null)
    {
        ...
        return $this->renderResponse('ApplicationSonataMediaBundle:Block:block_feature_media.html.twig', array(
            'media'     => $media,
            'block'     => $block,
            'settings'  => $settings
        ), $response);
